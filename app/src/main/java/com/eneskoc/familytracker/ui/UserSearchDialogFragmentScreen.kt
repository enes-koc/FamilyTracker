...
import com.eneskoc.familytracker.databinding.UserSearchDialogFragmentScreenBinding
...
@AndroidEntryPoint
class UserSearchDialogFragmentScreen : DialogFragment() {

    private var _binding: UserSearchDialogFragmentScreenBinding? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialog.setContentView(R.layout.user_search_dialog_fragment_screen)
    ...
    override fun onCreateView(
        ...
        _binding = UserSearchDialogFragmentScreenBinding.inflate(inflater, container, false)
        return binding.root
    }
